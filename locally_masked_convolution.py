...
class _LocallyMaskedConv2d(torch.autograd.Function):
    @staticmethod
...
class LocallyMaskedConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=(3, 3), dilation=1, bias=True, mask_weight=False):
        ...
        Args:
            ...
            kernel_size (tuple): Size of the convolution kernel as a tuple of two ints.
        ...
        """
        super(LocallyMaskedConv2d, self).__init__()
    ...
    def forward(self, x, mask=None):
        return _LocallyMaskedConv2d.apply(x, mask, self.weight, self.mask_weight, self.bias,
